...
describe("Dashboard", () => {
  it("deve ser capaz de listar todas as placas de comida da sua API", async () => {
    ...
    expect(
      getByText("Macarrão ao molho branco, fughi e cheiro verde das montanhas.")
    ).toBeTruthy();
  ...
  it("deve ser capaz de adicionar uma nova placa de comida", async () => {
    apiMock.onGet("foods").reply(200, []);
  ...
  it("deve ser capaz de editar uma placa de comida", async () => {
    apiMock.onGet("foods").reply(200, [
      {
        id: 1,
        name: "Ao molho",
  ...
  it("deve ser capaz de remover uma placa de comida", async () => {
    apiMock.onGet("foods").reply(200, [
      {
        id: 1,
        name: "Ao molho",
  ...
  it("deve ser capaz de atualizar a disponibilidade de uma placa de comida", async () => {
    apiMock.onGet("foods").reply(200, [
      {
        id: 1,
        name: "Ao molho",
